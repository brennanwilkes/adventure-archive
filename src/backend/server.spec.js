...
for (let i = -1; i < CONFIG.api.length; i++) {
	...
	['comment', 'thread', 'user'].forEach(endpoint => {
		test(`${endpoint} endpoint responds with api ${version || 'default'}`, async done => {
		...
		test(`Get ${endpoint}s resource collection with api ${version || 'default'}`, async done => {
		...
		test(`Get specific ${endpoint} resource with api ${version || 'default'}`, async done => {
		...
		test(`Get specific ${endpoint} resource which does not eixst with api ${version || 'default'}`, async done => {
		...
		test(`Get ${endpoint}s with limit param with api ${version || 'default'}`, async done => {
		...
		test(`Get ${endpoint}s with garbage param with api ${version || 'default'}`, async done => {
	...
	test(`Get comments with specific forum with api ${version || 'default'}`, async done => {
	...
	test(`Get comments with specific user with api ${version || 'default'}`, async done => {
	...
	test(`Search queries with api ${version || 'default'}`, async done => {
	...
	test(`Search users by name with api ${version || 'default'}`, async done => {
	...
	test(`Search threads by title with api ${version || 'default'}`, async done => {
	...
	test(`Search threads by country with api ${version || 'default'}`, async done => {
	...
	test(`Search threads by subforum with api ${version || 'default'}`, async done => {
	...
	test(`Search comments with aggregation pipeline, limiting comments per thread to 1 with api ${version || 'default'}`, async done => {
	...
	test(`Search comments with country and subforum pipeline with api ${version || 'default'}`, async done => {
	...
	test(`Get comments with random param with api ${version || 'default'}`, async done => {
	...
	test(`Post new user with api ${version || 'default'}`, async done => {
	...
	test(`Post new comment with api ${version || 'default'}`, async done => {
